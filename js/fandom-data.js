...
const MINIFAL_DATABASE = {
    ...
    modkits: [
        ...
        {
            id: "mod-kit-636",
            name: "Paintball Mod Kit (Omega)",
            category: "modkits",
            subType: "Geliştirme Modülü",
            rarity: "rare",
            rarityName: "Ender",
            ...
            change24h: 1.0,
            effects: "Atış İsabeti +%25, Mermi Hızı +%15",
            slotCost: "1 Yuva",
            compatibility: "Tüfekler, Pompalılar ve Ağır Silahlar",
            description: "Gri alet çantası ve turuncu yukarı ok simgeli resmi Minifal silah modifikasyon kiti.",
            source: "Dükkan / 636 Cash"
        },
        {
            id: "mod-kit-606",
            name: "Paintball Mod Kit (Alpha)",
            category: "modkits",
            subType: "Geliştirme Modülü",
            rarity: "rare",
            rarityName: "Ender",
            ...
            change24h: 1.0,
            effects: "Şarjör Kapasitesi +%30",
            slotCost: "1 Yuva",
            compatibility: "Tüm Silahlar",
            description: "Boya haznesi hacmini artıran birinci sınıf takım çantası kiti.",
            source: "Dükkan / 606 Cash"
        },
        {
            id: "mod-kit-588",
            name: "Paintball Mod Kit (Gamma)",
            category: "modkits",
            subType: "Geliştirme Modülü",
            rarity: "rare",
            rarityName: "Ender",
            ...
            change24h: 1.4,
            effects: "Atış Hızı +%18",
            slotCost: "1 Yuva",
            compatibility: "Hafif Makineli ve Hücum Tüfekleri",
            description: "Tetik mekanizmasını hızlandıran pnömatik valf takımı.",
            source: "Dükkan / 588 Cash"
        },
        {
            id: "mod-kit-570",
            name: "Paintball Mod Kit (Delta)",
            category: "modkits",
            subType: "Geliştirme Modülü",
            rarity: "rare",
            rarityName: "Ender",
            ...
            change24h: 0.9,
            effects: "Geri Tepme Kontrolü +%20",
            slotCost: "1 Yuva",
            compatibility: "Pompalılar ve Keskin Nişancılar",
            description: "Dipçik dengeleyici ve geri tepme amortisörü takımı.",
            source: "Dükkan / 570 Cash"
        },
        {
            id: "mod-kit-522",
            name: "Paintball Mod Kit (Beta)",
            category: "modkits",
            subType: "Geliştirme Modülü",
            rarity: "rare",
            rarityName: "Ender",
            ...
            change24h: 0.8,
            effects: "Şarjör Değiştirme Süresi -%25",
            slotCost: "1 Yuva",
            compatibility: "Tüm Silahlar",
            description: "Hızlı şarjör mandala adaptörü.",
